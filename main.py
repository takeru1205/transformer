...
from utils.dataset import KfttDataset
from utils.bleu import BleuScore
from utils.text import tensor_to_text, text_to_tensor, get_vocab
...
class Trainer:
    ...
    def fit(
        ...
        for i, (src, tgt) in enumerate(val_loader):
            ...
            if print_log:
                print(
                    f"train loss: {loss.item()}," + "iter: {i+1}/{len(val_loader)} \n"
                )
